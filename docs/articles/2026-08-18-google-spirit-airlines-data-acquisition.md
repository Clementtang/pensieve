---
title: "Google 花一千萬美元，買下一家倒閉航空公司的全部內部通訊"
...
2026 年 8 月 19 日上午 11 時，紐約南區破產法院將以 Zoom 舉行一場聽證。主持的 Sean H. Lane 法官要決定的事情，聽起來平淡無奇：核准一筆資產出售協議。但這筆資產不是飛機、不是機場時間帶，而是一家已經停飛的航空公司留下的數位遺骸，約一億封員工 email、五億則 Teams 訊息、數千萬份雲端文件，買家是 Google，成交價 1,000 萬美元。
...
對投資人與企業經營者而言，這則新聞同樣重要。它意味著公司倒閉時留下的不只是負債與殘值，還有一項過去從未被認真定價的資產：員工的數位工作紀錄。當這項資產第一次有了明確的成交價，後續的每一次企業清算，資料清單都會被重新檢視一遍。
...
拍賣本身只是 Spirit 漫長破產歷程的最後一幕。這家超低成本航空公司在 2024 年 1 月遭聯邦法官阻擋與 JetBlue 的 38 億美元併購案後股價重挫，同年 11 月首次聲請 Chapter 11，2025 年 3 月脫離保護，卻在同年 8 月二度聲請，負債高達 81 億美元。2026 年 5 月 2 日，Spirit 宣布立即結束營運，34 年的航空史就此畫下句點。此後的每一步都是清算式的資產拆解，機隊、LaGuardia 機場時間帶、Free Spirit 忠誠計畫、園區不動產，一項項被送上拍賣台。而 Google 買下的，是這場拆解中最不像傳統資產的一項：公司的數位神經系統。

### 買到了什麼，又刻意排除了什麼

法院文件與多家媒體報導的規模數字相互印證：約一億封 email、涵蓋約 8 萬個員工信箱帳號；約五億則 Microsoft Teams 訊息；1,710 萬個 OneDrive 檔案與 2,060 萬個 SharePoint 檔案；66 萬 7,563 筆 IT 服務工單；340 萬筆薪資紀錄，員工資料最早可回溯至 1986 年。資料主題橫跨營收管理、機隊營運、員工生產力，以及被多家媒體特別點名的「稽核與舞弊」。作為對照，學界長期使用的 Enron 語料庫僅約 50 萬封 email、150 名員工，規模不到 Spirit 資料集的百分之一，且缺乏即時通訊、雲端協作與 IT 工單這類現代企業工作流的痕跡。
...
放進 AI 資料授權市場的座標系裡，這個價格同樣顯得突兀。OpenAI 與 News Corp 的新聞內容授權為期五年、總價 2.5 億美元，折合年均 5,000 萬美元；Amazon 與《紐約時報》的授權每年 2,000 萬至 2,500 萬美元。這些都是需要每年續約、內容方隨時可能加價或提告的授權關係。相比之下，Google 用一次性的 1,000 萬美元，買斷了一整家公司永久的資料所有權，沒有續約風險，也沒有授權方回頭談判的餘地。原因並不複雜：賣方是清算中的破產財團，沒有議價的耐心，也沒有明天。這也是這起交易留給市場最直白的一句話，好資料的價格，取決於賣方還剩下多少選擇。

### 為什麼是現在，又為什麼是 Google

這筆交易之所以發生在 2026 年，背後有一個公開資料枯竭的大背景。研究機構 Epoch AI 以八成信心水準預測，網路上公開可得的人類生成文字存量將在 2026 至 2032 年間被耗盡。這意味著模型公司要繼續進步，勢必要找到公開網路以外的資料來源。而其中最稀缺的一種，是「多輪、跨系統、有真實結果的企業決策鏈」，一個排班衝突如何從第一封 email 走到最終審批，一次系統故障如何從報修工單走到修復結案。這類資料被 NDA、營業秘密與隱私法牢牢鎖在企業防火牆之內，健康經營的公司沒有任何理由出售它們。
...
這批資料還有一個較少被討論的限制，來自它的出身。這是一家兩度聲請破產、最終走向清算的超低成本航空公司留下的紀錄，時間分布高度集中在 2020 至 2026 年的困境期，充斥著成本壓縮、人力縮編與危機處理的痕跡。用這樣的語料訓練出來的企業代理，學到的很可能是「一家經營不善的公司如何做決策」，而不是產業的通則。對於評測而言，這種偏誤未必致命；但若要當成企業工作流的正面範本，恐怕需要相當程度的加權與過濾。
...
- 對跨國企業而言，員工資料若涉及歐盟籍員工，即便公司主體在美國清算，GDPR 的資料主體權利也不會因破產而自動消滅，這是多數亞洲企業從未認真評估過的曝險
