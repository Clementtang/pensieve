...
| P1-002 | 模板使用文件化 | 2026-01-12 | templates/README.md 新增決策樹 |
| P1-003 | README.md 版本資訊 | 2026-01-12 | 更新至 v1.4.0 |
| P1-006 | 模板初始化腳本 | 2026-01-12 | scripts/new-article.js |
| P1-010 | 標籤分類法標準化 | 2026-01-12 | docs/taxonomy.md |
| P1-015 | 研究提示詞模板 | 2026-01-12 | prompts/ 目錄 |
| P1-008 | M42 同步自動化 | 2026-01-13 | publish --auto-commit |
| P1-011 | Frontmatter 驗證腳本 | 2026-01-13 | validate-article.js 已完整 |
| P1-014 | Claude Hooks 整合 | 2026-01-13 | .claude/hooks/validate-on-write.js |
| P1-018 | 發布腳本錯誤處理 | 2026-01-13 | --verbose、錯誤摘要 |
...
| 2026-01-12 | 1.2.0 | 完成 P1-002、P1-003、P1-006、P1-010、P1-015 |
