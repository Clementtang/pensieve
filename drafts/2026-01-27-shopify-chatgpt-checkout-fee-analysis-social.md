...
還有一個值得關注的變數是廣告。OpenAI 已宣布將在 2 月開始測試廣告，雖然官方承諾「廣告不影響 ChatGPT 的回答」，但根據內部文件，OpenAI 的免費用戶變現目標是 2026 年 10 億美元，到 2029 年要成長到 250 億美元。這個規模的營收壓力下，「廣告不影響回答」的原則能維持多久？當年 Amazon 的 sponsored products 也是從「明確標示」開始，最終卻主導了整個搜尋結果。ChatGPT 會不會走上同樣的路，目前還是未知數。
