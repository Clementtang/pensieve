...
| 1-2 週    | topic-research-lite-template         | 2,000-5,000 字   |
...
- 元資料
- The Big Picture（大格局意義）
- Why It Matters（為什麼重要）
- 主要內容章節
- What's Next（後續發展與行動建議）
- 參考資料
...
- 歷史脈絡
- 利害關係人分析
- 多維度分析（選擇適用框架：PESTEL、經濟、社會文化、科技影響）
- 論證分析
- 比較分析
- 情境規劃
- 解決方案與建議
...
> 💡 這是深度版模板，如需快速分析請使用 Lite 版本

---

### 7. topic-research-lite-template.md (Lite)

**用途：** 議題研究（簡化版）- **推薦作為主要議題研究模板**
...
- 將研究成果轉化為社群貼文
- 跨平台發布（Facebook、LinkedIn、Threads、X）
- 維持品牌一致性

**包含結構：**

- 元資料（含原始研究連結）
- 完整版（1,500-2,500 字）- Facebook / LinkedIn
- 精簡版（500-800 字）- Threads
- 極簡版（280 字以內）- Twitter/X
- 發布指南（最佳時間、Hashtags、互動設計）
